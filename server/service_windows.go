...
//
// Under the SCM, Execute runs main_serve in a goroutine and translates SCM
// Stop/Shutdown into pushes on shutdown_request. Interactive mode falls through
// to the normal main_serve path, same as Unix.
