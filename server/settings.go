...
var system_settings = map[string]SystemSetting{
	...
	"map_tile_url": {
		...
		Description:  "Map tile URL template with {z}, {x} and {y} placeholders",
		UserReadable: true,
		ReadOnly:     false,
		Public:       true,
	},
	"map_tile_attribution": {
		...
		Description:  "Credit shown on every map for the tile source",
		UserReadable: true,
		ReadOnly:     false,
		Public:       true,
	},
...
//
//lint:ignore U1000 removes a row entirely, which setting_set(name, "") deliberately does not
