...
var system_settings = map[string]SystemSetting{
	...
	"auth_passkey": {
		...
		Pattern:      "^(required|allowed|disabled)$",
		Default:      "allowed",
		Description:  "Passkey login: required, allowed, or disabled",
		UserReadable: true,
		ReadOnly:     false,
		Public:       true,
	},
	"auth_totp": {
		...
		Pattern:      "^(required|allowed|disabled)$",
		Default:      "allowed",
		Description:  "Authenticator app (TOTP) login: required, allowed, or disabled",
		UserReadable: true,
		ReadOnly:     false,
		Public:       true,
	},
	...
	"auth_oauth": {
		...
		Pattern:      "^(required|allowed|disabled)$",
		Default:      "allowed",
		Description:  "Third-party (OAuth) login: required, allowed, or disabled",
		UserReadable: true,
		ReadOnly:     false,
		Public:       true,
	},
